...
export const ProjectsPage: React.FC = () => {
  ...
  return (
    <div className="space-y-8" id="projects-page-container">
      ...
      {/* Filter status */}
      <div className="flex gap-2 pb-2 border-b border-slate-800/60">
        <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {filteredProjects.map((project) => (
          <div
            ...
            className="group bg-[#111115]/90 backdrop-blur-sm border border-slate-800/80 hover:border-blue-500/40 rounded-2xl p-6 flex flex-col justify-between transition-all duration-300 hover:shadow-xl hover:shadow-blue-500/[0.04] hover:-translate-y-0.5"
          >
            <div>
              {/* Visual Preview Banner */}
              <div className="w-full bg-[#16161c] border border-slate-800/80 rounded-xl mb-4 flex flex-col justify-between overflow-hidden group-hover:border-slate-700 transition-colors relative">
                ...
                <div className="px-4 py-4 flex flex-col items-center justify-center text-center relative z-10 min-h-[64px]">
                  <span className="text-slate-200 group-hover:text-blue-300 font-mono font-extrabold text-sm tracking-wider uppercase transition-colors line-clamp-2">
                    {project.title}
                  </span>
                  ...
                  <div className="mt-3 flex items-center gap-1.5 text-[10px] text-slate-400 bg-[#0E0E12] px-2.5 py-1 rounded-md border border-slate-800 font-mono">
            ...
            <Link
              ...
              className="inline-flex items-center justify-between w-full px-4 py-2.5 rounded-xl bg-[#16161c] hover:bg-blue-600 hover:text-white border border-slate-800/90 hover:border-blue-500 text-xs font-semibold text-slate-300 transition-all duration-200 group-hover:border-slate-700 shadow-sm"
            >
